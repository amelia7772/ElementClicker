...
class Elements(pygame.sprite.Group):
    def __init__(self):
        ...
        self.elements.append(ElementLine((-125,350), 2, os.path.join("assets", "images" ,"gravel.png"), self.element_background, ElementExplanationMessage("Gravel", "Might contain small traces of gold, copper, and... cookies?!", get_recipe_for(ElementType.gravel), self.element_explanation_background, pygame.Rect((100,0), (300, 217)))))
