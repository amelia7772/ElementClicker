...
class Elements(pygame.sprite.Group):
    def __init__(self):
        ...
        self.elements.append(ElementLine((-675,200), os.path.join("assets", "images" ,"clay.png"), self.element_background, ElementExplanationMessage("Clay", "you can shape it however you want... yes, including as a [redacted]", get_recipe_for(ElementType.clay), self.element_explanation_background, pygame.Rect((100,0), (300, 217)))))
