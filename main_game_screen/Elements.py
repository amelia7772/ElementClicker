...
class Elements(pygame.sprite.Group):
    def __init__(self):
        ...
        self.elements.append(ElementLine((400,50), 1, os.path.join("assets", "images" ,"wood log 16-bit.png"), self.element_background, ElementExplanationMessage("Wood", "You punch a tree, you get wood!", get_recipe_for(ElementType.wood), self.element_explanation_background, pygame.Rect((100,0), (300, 217)))))
        self.elements[0].is_available = True
        self.elements.append(ElementLine((125,50), 2, os.path.join("assets", "images" ,"fire 16-bit.png"), self.element_background, ElementExplanationMessage("Fire", "The first element!", get_recipe_for(ElementType.fire), self.element_explanation_background, pygame.Rect((100,0), (300, 217)))))
        self.elements.append(ElementLine((675,50), 1, os.path.join("assets", "images" ,"rock.png"), self.element_background, ElementExplanationMessage("Rock", "... Are you sure you want to punch it bare-handed?!", get_recipe_for(ElementType.rock), self.element_explanation_background, pygame.Rect((100,0), (300, 217)))))
        self.elements.append(ElementLine((125,200), 3, os.path.join("assets", "images" ,"iron ingot 16-bit.png"), self.element_background, ElementExplanationMessage("Iron", "Burn the rocks until you uncover the iron in them!", get_recipe_for(ElementType.iron), self.element_explanation_background, pygame.Rect((100,0), (300, 217)))))
        self.elements.append(ElementLine((400,200), 4, os.path.join("assets", "images" ,"bucket.png"), self.element_background, ElementExplanationMessage("Bucket", "A man cannot own a Bucket, it's man who shall kneel before The Bucket!!", get_recipe_for(ElementType.bucket), self.element_explanation_background, pygame.Rect((100,0), (300, 217)))))
        self.elements.append(ElementLine((675,200), 1, os.path.join("assets", "images" ,"water.png"), self.element_background, ElementExplanationMessage("Water", "Also known as hydroxic acid, killed more people than cyanide!", get_recipe_for(ElementType.water), self.element_explanation_background, pygame.Rect((100,0), (300, 217)))))
        self.elements.append(ElementLine((125,350), 4, os.path.join("assets", "images" ,"iron pickaxe.png"), self.element_background, ElementExplanationMessage("Iron Pickaxe", "Makes punching rocks far easier!", get_recipe_for(ElementType.iron_pickaxe), self.element_explanation_background, pygame.Rect((100,0), (300, 217)))))
        self.elements.append(ElementLine((400,350), 4, os.path.join("assets", "images" ,"iron hammer.png"), self.element_background, ElementExplanationMessage("Iron Hammer", "Crushes rocks into dust... don't ask why...", get_recipe_for(ElementType.iron_hammer), self.element_explanation_background, pygame.Rect((100,0), (300, 217)))))
        self.elements.append(ElementLine((675,350), 4, os.path.join("assets", "images" ,"iron axe.png"), self.element_background, ElementExplanationMessage("Iron Axe", "Pffft, who needs that?! fists do the job far more naturally!", get_recipe_for(ElementType.iron_axe), self.element_explanation_background, pygame.Rect((100,0), (300, 217)))))
        self.elements.append(ElementLine((125,-100), 4, os.path.join("assets", "images" ,"iron hoe.png"), self.element_background, ElementExplanationMessage("Iron Hoe", "... What? You need an explanation of what a hoe is?!", get_recipe_for(ElementType.iron_hoe), self.element_explanation_background, pygame.Rect((100,0), (300, 217)))))
        self.elements.append(ElementLine((400,-100), 4, os.path.join("assets", "images" ,"iron shovel.png"), self.element_background, ElementExplanationMessage("Iron Shovel", "Diggy diggy hole, digging a hole!", get_recipe_for(ElementType.iron_shovel), self.element_explanation_background, pygame.Rect((100,0), (300, 217)))))
        ...
        self.elements.append(ElementLine((-400,350), 3, os.path.join("assets", "images" ,"wheat plant.png"), self.element_background, ElementExplanationMessage("Wheat Plant", "How do I get the plants off the farmlands?!", get_recipe_for(ElementType.wheat_plant), self.element_explanation_background, pygame.Rect((100,0), (300, 217)))))
        self.elements.append(ElementLine((-400,500), 4, os.path.join("assets", "images" ,"harvested wheat.png"), self.element_background, ElementExplanationMessage("Harvested Wheat", "You need more than 3 to make bread.", get_recipe_for(ElementType.harvested_wheat), self.element_explanation_background, pygame.Rect((100,0), (300, 217)))))
        self.elements.append(ElementLine((-675,50), 5, os.path.join("assets", "images" ,"heybale.png"), self.element_background, ElementExplanationMessage("Heybale", "Feed it to the animals!", get_recipe_for(ElementType.heybale), self.element_explanation_background, pygame.Rect((100,0), (300, 217)))))
        self.elements.append(ElementLine((950,200), 2, os.path.join("assets", "images" ,"clay.png"), self.element_background, ElementExplanationMessage("Clay", "you can shape it however you want... yes, including as a [redacted]", get_recipe_for(ElementType.clay), self.element_explanation_background, pygame.Rect((100,0), (300, 217)))))
        self.elements.append(ElementLine((1125,200), 3, os.path.join("assets", "images" ,"brick.png"), self.element_background, ElementExplanationMessage("Brick", "very dense hardened clay used for building (other applications left to the imagination of the reader)", get_recipe_for(ElementType.brick), self.element_explanation_background, pygame.Rect((100,0), (300, 217)))))
        self.elements.append(ElementLine((950,50), 4, os.path.join("assets", "images" ,"cement.png"), self.element_background, ElementExplanationMessage("Cement", "the perfect material to fill a swiming pool with!", get_recipe_for(ElementType.cement), self.element_explanation_background, pygame.Rect((100,0), (300, 217)))))
        ...
        self.elements.append(ElementLine((1475,200), 6, os.path.join("assets", "images" ,"production facility tier 2.png"), self.element_background, ElementExplanationMessage("Production Facility Tier 2", "automatically produces more of the last item you clicked on, provided it's crafted from 1st tier items", get_recipe_for(ElementType.factory_tier_two), self.element_explanation_background, pygame.Rect((100,0), (300, 217)))))
        self.elements.append(ElementLine((1650,200), 6, os.path.join("assets", "images" ,"production facility tier 3.png"), self.element_background, ElementExplanationMessage("Production Facility Tier 3", "automatically produces more of the last item you clicked on, provided it's crafted from 2nd tier items", get_recipe_for(ElementType.factory_tier_three), self.element_explanation_background, pygame.Rect((100,0), (300, 217)))))
